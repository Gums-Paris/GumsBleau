...
public class NetworkConnectionMonitor extends LiveData<Boolean> {
    ...
    private NetworkConnectionMonitor(@NonNull Context context) { mcontext = context.getApplicationContext();}
...
// si il est nécessaire que getInstance soit threadsafe il faut "static synchronized NetWork..."
    ...
    static NetworkConnectionMonitor getInstance() { return instance;}
